...
*  Use pre-computed .npy (no audio in output video)
```shell
python inference.py \
    --data_root "./checkpoints/ditto_pytorch" \
    --cfg_pkl "./checkpoints/ditto_cfg/v0.4_hubert_cfg_pytorch.pkl" \
    --audio_feat_path "./audio_features.npy" \
    --source_path "./example/image.png" \
    --output_path "./tmp/result.mp4"

```
*  Use .npy features + mux original audio into video (most useful)
```shell
python inference.py \
    --data_root "./checkpoints/ditto_pytorch" \
    --cfg_pkl "./checkpoints/ditto_cfg/v0.4_hubert_cfg_pytorch.pkl" \
    --audio_feat_path "./audio_features.npy" \
    --audio_path_for_mux "./example/audio.wav" \
    --source_path "./example/image.png" \
    --output_path "./tmp/result.mp4"
